#!/usr/bin/env python3
"""
Teste para verificar o chat ID específico: 120363352636641881
"""
...
def testar_chat_especifico():
    ...
    chat_id_teste = "120363352636641881"
    ...
    # Verificar padrão 120363
    if chat_id_teste.startswith('120363'):
        print("🚫 Começa com 120363 (padrão de grupo)")
    else:
        print("✅ Não começa com 120363")
    
    # Verificar comprimento
    if len(chat_id_teste) > 15:
        print(f"🚫 Número muito longo ({len(chat_id_teste)} dígitos) - possível grupo")
    else:
    ...
    chats_existentes = Chat.objects.filter(chat_id__icontains="120363352636641881")
    ...
    mensagens = Mensagem.objects.filter(chat__chat_id__icontains="120363352636641881")
